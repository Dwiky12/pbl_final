...
use App\Filament\Exports\DokumenKurikulumExporter;
...
class DokumenKurikulumResource extends Resource
{
    ...
    {
        return 'Dokumen Kurikulum';
    }
    public static function getPluralModelLabel(): string
    {
        return 'Daftar Dokumen Kurikulum';
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('setuju')
                        ...
                        ->color('success')
                        ->action(fn(DokumenKurikulum $record) => $record->update(['status' => DokumenKurikulum::STATUS_SETUJU]))
                    ...
                    Tables\Actions\Action::make('tolak')
                        ...
                        ->action(function (DokumenKurikulum $record, array $data) {
                            $record->update([
                                'status' => DokumenKurikulum::STATUS_TOLAK,
            ...
            ->headerActions([
                ExportAction::make()->exporter(DokumenKurikulumExporter::class)
                    ->label('Export')
                    ->color('info')
            ])
            ->bulkActions([
