...
use App\Filament\Exports\SopExporter;
...
class SopResource extends Resource
{
    ...
    protected static ?string $label = 'SOP';
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\ViewAction::make('view-komentar')
                    ...
                    Tables\Actions\Action::make('setuju')
                        ...
                        ->color('success')
                        ->action(fn(Sop $record) => $record->update(['status' => Sop::STATUS_SETUJU]))
            ...
            ->headerActions([
                ExportAction::make()->exporter(SopExporter::class)
                    ->label('Export')
                    ->color('info')
            ])
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\DeleteBulkAction::make()
                        ->hidden(auth()->user()->role == "dosen"),
                    ExportBulkAction::make()->exporter(SopExporter::class)
                        ->label('Export')
                        ->color('info')
                ]),
            ]);
